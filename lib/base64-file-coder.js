...
Base64FileCoder.prototype.encode = function (path, callback) {
  ...
  if (typeof callback !== 'function' || !(callback instanceof Function)) {
    throw new Error(
      'encode(): callback is undefined or contains non-function value'
    );
  }
...
/**
 * @public
 * @description Expose instance of Base64FileCoder.
 * @returns {Object} - Instance of Base64FileCoder.
 */

module.exports = () => {
  return new Base64FileCoder();
};
